...
class Submitter(QWidget):
    def __init__(self, model):
        super().__init__()
        try:
            print("ReplaceA Submitter 생성자 진입")
    ...
    def setup_ui(self):
        ...
        print("ReplaceA UI 로딩 완료")
        self.ui.show()
        print("ReplaceA UI 화면 show() 호출됨")
...
#####################################################################################
    def click_send_to_deadline(self):
        ...
        print("ReplaceA send_to_deadline 버튼 연결 완료")
...
if __name__ == "__main__":
    ...
    window = Submitter()
    window.show()
    print("ReplaceA Submitter window.show() 완료")
    try:
        sys.exit(app.exec())
